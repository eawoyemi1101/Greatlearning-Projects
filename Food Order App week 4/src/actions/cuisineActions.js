...
// Action to fetch the list of cuisines
...
// Action to fetch details of a single cuisine
export const fetchCuisineDetails = (cuisineId) => async (dispatch) => {
  try {
    ...
    dispatch({
      type: CUISINE_DETAILS_FAILURE,
      payload: err.response?.data?.message || "Error fetching cuisine details",
    });
  }
};
